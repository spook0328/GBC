...
CREATE TABLE IF NOT EXISTS `mydb`.`Patients` (
  ...
  PRIMARY KEY (`patient_id`, `Emergency Contact Person_emergency_contact_person_id`, `Doctors_doctor_id`),
  ...
  CONSTRAINT `fk_Patients_Emergency Contact Person1`
    ...
    REFERENCES `mydb`.`Emergency Contact Person` (`emergency_contact_person_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Patient History` (
  ...
  `Patients_patient_id` INT NOT NULL,
  PRIMARY KEY (`patient_history_id`, `Patients_patient_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Patient Prescription` (
  ...
  CONSTRAINT `fk_Patient Prescription_Patient Visit1`
    ...
    REFERENCES `mydb`.`Patient Visit` (`patient_visit_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Diagnostic Test` (
  ...
  PRIMARY KEY (`patient_diagnostic_test_id`, `Patient Prescription_patient_prescription_id`),
  ...
  CONSTRAINT `fk_Diagnostic Test_Patient Prescription1`
    ...
    REFERENCES `mydb`.`Patient Prescription` (`patient_prescription_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Appointment Follow Up`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Appointment Follow Up` (
  `appointment_followup_id` INT NOT NULL COMMENT 'Primary key on appointment followup table',
...
-- -----------------------------------------------------
-- Table `mydb`.`Health Insurance`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Health Insurance` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Billing` (
  ...
  `Appointments_appointment_id` INT NOT NULL,
  PRIMARY KEY (`billing_id`, `Appointments_appointment_id`),
...
-- -----------------------------------------------------
-- Table `mydb`.`Billing Details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Billing Details` (
  ...
  PRIMARY KEY (`billing_details_id`, `Billing_billing_id`, `Services_services_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Billing_Has_Insurance` (
  ...
  CONSTRAINT `fk_Health Insurance_has_Billing_Health Insurance1`
    ...
    REFERENCES `mydb`.`Health Insurance` (`health_insurance_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
