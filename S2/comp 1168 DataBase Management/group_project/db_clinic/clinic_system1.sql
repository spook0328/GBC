...
CREATE TABLE IF NOT EXISTS `clinic_system`.`patients` (
  ...
  `patient_first_name` VARCHAR(100) NOT NULL COMMENT 'Patient First Name\n',
...
START TRANSACTION;
USE `clinic_system`;
INSERT INTO `clinic_system`.`doctors` (`doctor_id`, `doctor_first_name`, `doctor_last_name`, `doctor_phone_number`, `doctor_date_of_birth`, `doctor_email`) VALUES (1, 'Teady', 'Colon', '258-367-4041', '1994-12-05', 'T.Colon@torontoclinic.ca');
...
START TRANSACTION;
USE `clinic_system`;
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (1, 'Ava', 'Reid', '1940-08-17', '945 Bogisich Plaza', 'Toronto', 'N2A 2N9', 'Ontario', '519-895-4675', 'AvaReid@gmail.com', 'enrolled', 1, 1);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (2, 'Hallie', 'Rosales', '1977-02-23', '900 Massachusetts St', 'Bolton', '66044', 'Ontario', '456-778-0125', 'AvaReid@gmail.com', 'enrolled', 2, 2);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (3, 'Dana', 'Greene', '1979-01-05', '4415 Park Blvd', 'Hamilton', '08260', 'Ontario', '164-013-4545', 'DanaGreene@gmail.com', 'enrolled', 3, 3);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (4, 'Norman', 'Walton', '1943-06-21', '210 James St', 'Hamilton', 'L8R 2L2', 'Ontario', '435-215-0135', 'NormanWalton@gmail.com', 'walk-in', 6, NULL);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (5, 'Fatimah', 'Grace', '1938-08-16', '9528 25 Hwy', 'Toronto', 'L9T 2X7', 'Ontario', '445-785-1125', 'FatimahGrace@gmail.com', 'enrolled', 4, 5);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (6, 'Robert', 'Tanner', '1999-05-20', '6200 University Blvd', 'Markham', 'V6T 1Z3', 'Ontario', '457-233-6666', 'RobertTanner@gmail.com', 'walk-in', 7, NULL);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (7, 'Ilyas', 'Boyd', '2017-11-14', '2534A Twp Rd 245A', 'RichmondHill', 'T7X 5A3', 'Ontario', '468-112-4016', 'IlyasBoyd@gmail.com', 'walk-in', 8, NULL);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (8, 'Victor', 'Higgins', '2022-05-08', '6116 Broadway', 'Toronto', '07093', 'Ontario', '519-487-1102', 'VictorHiggins@gmail.com', 'walk-in', 9, NULL);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (9, 'Jacques', 'O\'Quinn', '1956-12-28', '215 Chain Lake Dr', 'Hamilton', 'B3S 1C9', 'Ontario', '647-220-6485', 'JacquesOQuinn@gmail.com', 'walk-in', 10, NULL);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (10, 'Gemma', 'Schmidt', '2024-10-24', '1544 Pacific Ave', 'Bolton', '08400', 'Ontario', '447-448-7878', 'GemmaSchmidt@gmail.com', 'enrolled', 5, 10);
...
START TRANSACTION;
USE `clinic_system`;
INSERT INTO `clinic_system`.`appointments` (`appointment_id`, `appointment_date`, `appointment_time`, `appointment_status`, `patient_id`, `doctor_id`) VALUES (1, '2023-12-05', '10:00', 'Cancelled', 2, 1);
INSERT INTO `clinic_system`.`appointments` (`appointment_id`, `appointment_date`, `appointment_time`, `appointment_status`, `patient_id`, `doctor_id`) VALUES (2, '2023-12-12', '14:30', 'Cancelled', 8, 3);
INSERT INTO `clinic_system`.`appointments` (`appointment_id`, `appointment_date`, `appointment_time`, `appointment_status`, `patient_id`, `doctor_id`) VALUES (3, '2023-12-17', '09:45', 'Cancelled', 1, 7);
INSERT INTO `clinic_system`.`appointments` (`appointment_id`, `appointment_date`, `appointment_time`, `appointment_status`, `patient_id`, `doctor_id`) VALUES (4, '2023-12-01', '11:15', 'Cancelled', 4, 9);
...
INSERT INTO `clinic_system`.`appointments` (`appointment_id`, `appointment_date`, `appointment_time`, `appointment_status`, `patient_id`, `doctor_id`) VALUES (7, '2023-12-30', '20:30', 'Cancelled', 10, 4);
...
INSERT INTO `clinic_system`.`appointments` (`appointment_id`, `appointment_date`, `appointment_time`, `appointment_status`, `patient_id`, `doctor_id`) VALUES (11, '2022-12-12', '10:00', 'Checked In', 1, 9);
INSERT INTO `clinic_system`.`appointments` (`appointment_id`, `appointment_date`, `appointment_time`, `appointment_status`, `patient_id`, `doctor_id`) VALUES (12, '2022-12-12', '12:00', 'Booked', 5, 9);
INSERT INTO `clinic_system`.`appointments` (`appointment_id`, `appointment_date`, `appointment_time`, `appointment_status`, `patient_id`, `doctor_id`) VALUES (13, '2022-12-12', '18:00', 'Booked', 10, 9);
