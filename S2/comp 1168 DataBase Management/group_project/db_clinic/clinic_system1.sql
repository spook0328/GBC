...
START TRANSACTION;
USE `clinic_system`;
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (1, 'Ava', 'Reid', '1940-08-17', '945 Bogisich Plaza', 'Kitchener', 'N2A 2N9', 'Ontario', '519-895-4675', 'AvaReid@gmail.com', 'enrolled', 1, 1);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (2, 'Hallie', 'Rosales', '1977-02-23', '900 Massachusetts St', 'Lawrence', '66044', 'Ontario', '456-778-0125', 'AvaReid@gmail.com', 'enrolled', 2, 2);
INSERT INTO `clinic_system`.`patients` (`patient_id`, `patient_first_name`, `patient_last_name`, `patient_date_of_birth`, `patient_address`, `city`, `zipcode`, `province`, `patient_phone_number`, `patient_email`, `patient_type`, `emergency_contact_id`, `doctor_id`) VALUES (3, 'Dana', 'Greene', '1979-01-05', '4415 Park Blvd', 'Wildwood', '08260', 'Ontario', '164-013-4545', 'DanaGreene@gmail.com', 'enrolled', 3, 3);
